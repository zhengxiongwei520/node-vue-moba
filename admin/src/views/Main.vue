<template>
  <el-container style="height: 100vh;">
      ...
      <el-menu router :default-active="$route.path">
        <el-submenu index="1">
          ...
          <el-menu-item-group>
            ...
            <el-menu-item index="/cates/create">新建分类</el-menu-item>
            <el-menu-item index="/cates/list">分类列表</el-menu-item>
          </el-menu-item-group>
          ...
          <el-menu-item-group>
            ...
            <el-menu-item index="/strategies/create">新建攻略</el-menu-item>
    ...
    <el-container>
      ...
      <router-view class="routerView" :key="$route.path"></router-view>
    </el-container>
  </el-container>
</template>
